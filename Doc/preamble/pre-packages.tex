...
\usepackage[ngerman]{babel} % Languagesetting %ngerman %UKenglish
...
\usepackage{todonotes} %Including Todo notes
\usepackage{rotating} 	%Allows text rottating
\usepackage{multirow}
\usepackage{multicol} 
...
\renewcommand{\nomgroup}[1]{% 
	...
	\ifthenelse{\equal{#1}{F}}{% 
		\item[\textbf{\Large Formelzeichen}]}{
...
% 6. Pakete zum Zitieren
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%\usepackage{jura} % footnotes
%\usepackage{footbib} % footnotes


%\usepackage[style=authortitle-icomp,autocite=footnote,natbib=true,backend=biber]{biblatex} %,doi=true
%\usepackage[style=numeric,backend=biber]{biblatex} %,doi=true
\usepackage[
firstinits=true, % render first and middle names as initials
maxcitenames=3,
maxbibnames=99,
style=authoryear-comp, % ohne dieser Einstellung --> [1]
...
\renewcommand{\floatpagefraction}{.75} % vorher: .5,.75
\renewcommand{\textfraction}{.1}       % vorher: .2,.1
\renewcommand{\topfraction}{.8}        % vorher: .7,.8
\renewcommand{\bottomfraction}{.5}     % vorher: .3,.5
\setcounter{topnumber}{3}	         % vorher: 2,3
\setcounter{bottomnumber}{2}	         % vorher: 1,2
\setcounter{totalnumber}{5}	         % vorher: 3,5
...
commentstyle =\color{green}, %teal
stringstyle = \color{red}, % Farbe der Zeichenketten  \itshape,
...
\usepackage[left=3.8cm,right=1.5cm,top=1.1cm,bottom=1.4cm,includefoot,includehead]{geometry}
...
\addtolength{\skip\footins}{0.5\baselineskip} % Abstand Text <-> Fussnote
...
\setkomafont{pageheadfoot}{\small\rmfamily}	       % Kopfzeile

\setkomafont{descriptionlabel}{\itshape}        % Stichwortliste
%
\renewcommand*{\raggedsection}{\raggedright} % Titelzeile linksbuendig, haengend
\renewcommand{\chapterheadstartvskip}{\vspace*{0.3\baselineskip}} %space between page top and chapter heading
